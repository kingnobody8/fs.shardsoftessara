...
void CSGD_EventSystem::SendEvent( EVENTID eventID, void* pData, void* pDestination, void* pSender )
{
...
void CSGD_EventSystem::SendEventNow( EVENTID eventID, void* pData, void* pDestination, void* pSender )
{
